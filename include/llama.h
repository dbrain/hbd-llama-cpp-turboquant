...
extern "C" {
    ...
    struct llama_context_params {
        ...
        bool mtp_enabled; // build the multi-token-prediction head when the model has nextn layers
                          // ignored on models without an MTP head; default false — set by spec-decode callers
